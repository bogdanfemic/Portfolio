...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typeof THREE === 'undefined') {
    console.error('THREE.js library not loaded. Skipping 3D background initialization.');
    return;
  }

  // Only initialize if the home section exists
  const homeSection = document.getElementById('home');
  if (!homeSection) {
    console.warn('Home section not found. Skipping 3D background initialization.');
    return;
  }
  ...
  // Set renderer size and append to home section
  ...
  // Insert container as the first child of home section
